...
router.get('/email/:userID',UserController.user_detailsByEmail); 
...
router.patch('/setotp/:userID',UserController.user_otp);

router.patch('/resetpwd/:userID',UserController.update_user_resetpassword);    

router.patch('/patch/one/resetpwd/:userID',UserController.update_user_resetpwd);    
