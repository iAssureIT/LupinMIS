...
router.post('/post/stateBulkinsert', StatesController.stateBulkinsert);
...
router.get('/get/:stateID', StatesController.fetchState);

router.delete('/:stateID', StatesController.delete_state);
