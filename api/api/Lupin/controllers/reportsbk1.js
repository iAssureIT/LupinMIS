                    ...
                    if(req.params.activity_ID === 'all'){
                        ...
                        if(req.params.subactivity_ID === 'all'){
                            query = {
                                    $match : {
                                                sector_ID         : String(req.params.sector_ID),
                                                activity_ID       : String(req.params.activity_ID),
                                                date              : {$gte : req.params.startDate, $lte : req.params.endDate}
                                    }
                                };
                        }else{
                            query = {
                                    $match : {
                                                sector_ID         : String(req.params.sector_ID),
                                                activity_ID       : String(req.params.activity_ID),
                                                subactivity_ID    : String(req.params.subactivity_ID),
                                                date              : {$gte : req.params.startDate, $lte : req.params.endDate}
                                    }
                                };
                        }
                                            ...
                                            for(j = 0 ; j < sector_subactivity.length ; j++){
                                                ...
                                                if(activityReportdata.projectCategoryType != 0 && activityReportdata.projectName != 0){
                                                    ...
                                                    returnData.push({
                                                        ...
                                                        "Quantity"              : activityReportdata.PhysicalUnit,
                                                        "Amount"                : activityReportdata.TotalBudget / 100000,
                                                        "Beneficiaries"         : activityReportdata.Reach,
                                                        "LHWRF"                 : activityReportdata.LHWRF / 100000,
                                                        "NABARD"                : activityReportdata.NABARD / 100000,
                                                        "Govt"                  : activityReportdata.Govt / 100000,
                                                        "Bank"                  : activityReportdata.Bank_Loan / 100000,
                                                        "Community"             : (activityReportdata.DirectCC + activityReportdata.IndirectCC) / 100000, 
                                                        "Other"                 : activityReportdata.Other / 100000,
                                                        "projectCategoryType"   : activityReportdata.projectCategoryType,
                                                        "projectName"           : activityReportdata.projectName != 'all' ? activityReportdata.projectName : "-",
                                                    });
                                                }
                                                ...
                                                returnData.push(
                                                    {
                                                        ...
                                                        "LHWRF"                 : LHWRF / 100000,
                                                        "NABARD"                : NABARD / 100000,
                                                        "Govt"                  : govt / 100000,
                                                        "Bank"                  : bank / 100000,
                                                        "Community"             : community / 100000, 
                                                        "Other"                 : Other / 100000, 
                                                        "projectCategoryType"   : "-",
                                                        "projectName"           : "-",
                                                    },
