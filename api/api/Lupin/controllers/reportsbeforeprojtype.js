            ...
            for(i = 0 ; i < data.length; i++){
                ...
                switch(selectData){
                    case "subActivities" :
                        ...
                        var selectDataName = {
                                "name"      : "<b>Sector : </b>"+data[i].sector+"<br/><b>Activity : </b>" + data[i].activityName + "<br/><b>Sub-Activity : </b>" + data[i].subActivityName,
                                "unit"      : data[i].unit
                        };
                    break;
                    case "sector"   :
        ...
        ActivityReport.aggregate(
                        ...
                        .then(data=>{
                            ...
                            async function  getAsyncData(){
                                ...
                                resolve({
                                            "Reach"                  : Reach_FamilyUpgradation.Reach,
                                            "FamilyUpgradation"      : Reach_FamilyUpgradation.FamilyUpgradation,
...
exports.report_village = (req,res,next)=>{
    ...
    ActivityReport.aggregate(
                                    [
                                        ...
                                        {
                                            $project : {
                                                "name"              : "<b>Sector : </b>"+"$sectorName"+"<br/><b>Activity : </b>" + "$activityName" + "<br/><b>Sub-Activity : </b>" + "$subactivityName",
                                                "familyID"          : 1,
                                                "activityName"      : 1,
                                                "subactivityName"   : 1,
                                                "unit"              : 1,
                                            ...
                                            for(j = 0 ; j < sector_subactivity.length ; j++){
                                                ...
                                                if(activityReportdata.projectCategoryType != 0 && activityReportdata.projectName != 0){
                                                    ...
                                                    returnData.push({
                                                        ...
                                                        "activityName"          : "<b>Sector : </b>"+sector_subactivity[j].sectorName+"<br/><b>Activity : </b>" + sector_subactivity[j].activityName + "<br/><b>Sub-Activity : </b>" + sector_subactivity[j].subActivityName,
                                                        "unit"                  : (sector_subactivity[j].unit).toFixed(2),
                                                        "Quantity"              : activityReportdata.PhysicalUnit,
                                                        "Amount"                : (activityReportdata.TotalBudget / 100000).toFixed(2),
                                                        "Beneficiaries"         : activityReportdata.Reach,
                                                        "LHWRF"                 : (activityReportdata.LHWRF / 100000).toFixed(2),
                                                        "NABARD"                : (activityReportdata.NABARD / 100000).toFixed(2),
                                                        "Govt"                  : (activityReportdata.Govt / 100000).toFixed(2),
                                                        "Bank"                  : (activityReportdata.Bank_Loan / 100000).toFixed(2),
                                                        "Community"             : ((activityReportdata.DirectCC + activityReportdata.IndirectCC) / 100000).toFixed(2), 
                                                        "Other"                 : (activityReportdata.Other / 100000).toFixed(2),
                                                        "projectCategoryType"   : activityReportdata.projectCategoryType,
                                                        "projectName"           : activityReportdata.projectName != 'all' ? activityReportdata.projectName : "-",
                                                    });
                                                }
                                                ...
                                                returnData.push(
                                                    {
                                                        ...
                                                        "LHWRF"                 : (LHWRF / 100000).toFixed(2),
                                                        "NABARD"                : (NABARD / 100000).toFixed(2),
                                                        "Govt"                  : (govt / 100000).toFixed(2),
                                                        "Bank"                  : (bank / 100000).toFixed(2),
                                                        "Community"             : (community / 100000).toFixed(2), 
                                                        "Other"                 : (Other / 100000).toFixed(2), 
                                                        "projectCategoryType"   : "-",
                                                        "projectName"           : "-",
                                                    },
                                                    {
                                        ...
                                        for(j = 0 ; j < sector_subactivity.length ; j++){
                                            ...
                                            if(activityReportdata.projectCategoryType != 0 && activityReportdata.projectName != 0){
                                                ...
                                                returnData.push({
                                                    ...
                                                    "activityName"          : "<b>Sector : </b>"+sector_subactivity[j].sectorName+"<br/><b>Activity : </b>" + sector_subactivity[j].activityName + "<br/><b>Sub-Activity : </b>" + sector_subactivity[j].subActivityName,
                                                    "unit"                  : (activityReportdata.unit).toFixed(2),
                                                    "Quantity"              : activityReportdata.PhysicalUnit,
                                                    "Amount"                : (activityReportdata.TotalBudget / 100000).toFixed(2),
                                                    "Beneficiaries"         : activityReportdata.Reach,
                                                    "LHWRF"                 : (activityReportdata.LHWRF / 100000).toFixed(2),
...
exports.report_goal = (req,res,next)=>{
    ...
    async function getData(){
        ...
        if(req.params.projectCategoryType === "Project Fund"){
            dataReturn = await sectorMappingData(req.params.startDate,req.params.endDate,req.params.center_ID,req.params.goal_type,req.params.uidstatus,req.params.projectCategoryType,req.params.projectName);
        }else{
            ...
            for(i = 0 ; i < data.length; i++){
                ...
                switch(filterCondition){
                    case 'annual' : 
                        ...
                        break;
                    case 'periodic' : 
                        ifCondition = annualPlanData.TotalBudget !== 0 && annualPlanData.PhysicalUnit !== 0 && annualPlanData.Reach !== 0 && monthlyPlanData.TotalBudget !== 0 && monthlyPlanData.PhysicalUnit !== 0 && monthlyPlanData.Reach !== 0;
                        break;
                    case 'achievement' : 
            ...
            .then(sec_activity_subactivity=>{
                ...
                async function getData(){
                    if(sec_activity_subactivity.length > 0){
                        ...
                        console.log("sector length ",returData.length)
                        res.status(200).json(returData);
                    }else{
                        res.status(200).json({message:"Data not found"});
                    }
...
exports.reports_activity_periodic_plan = (req,res,next)=>{ 
    ...
    console.log("activity_subactivity_query",activity_subactivity_query);
    Sectors .aggregate(
                        [
                            query,
                            {
...
exports.reports_sector_annual_plan= (req,res,next)=>{ 
    console.log("reports_sector_annual_plan ",req.params);
    var deriveDate = derive_year_month({startDate : req.params.startDate, endDate : req.params.endDate});
    Sectors .aggregate(
                        [
                            {
...
exports.temp_controller = (req,res,next)=>{
   ...
   { sector_ID: '5df3d38e10faa90bf925c48f',
     activity_ID: '5df3d39b10faa90bf925c490',
     subactivity_ID: '5df3d3b610faa90bf925c491',
     date: { '$gte': '2019-04-01', '$lte': '2020-03-31' } } };
    var currtentActivityReportQuery = { '$match':
       { sector_ID: '5df3d38e10faa90bf925c48f',
         activity_ID: '5df3d39b10faa90bf925c490',
         subactivity_ID: '5df3d3b610faa90bf925c491',
         date: { '$gte': '2019-12-01', '$lte': '2019-12-31' } } };
