	...
	componentDidMount(){
        ...
        {         
         if (element.attr("name") == "pincode"){
            ...
            if (element.attr("name") == "districtval"){
               error.insertAfter("#districtval");
            }

            if (element.attr("name") == "talukaval"){
               error.insertAfter("#talukaval");
            }
          }
	   });
...
*/
	...
	showBtn(){
		if(this.state.locationId){
			...
			return(
	    			<button type="submit" className="pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12  submit btn_mrg2 btnSubmit" onClick={this.addlocation.bind(this)} >Submit</button>
			)
		}
	}
							...
							<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 masterInputPadding ">
								<div className="form-group col-lg-4 col-md-4 col-xs-12 col-sm-12  valid_box">
									<div className="form-group">
									    <label className="">Country<span className="asterix">*</span></label>
									   	<select required onChange={this.changeCountry.bind(this)} title="This field is required" className="inputBox-main countrySelected areaStaes form-control" ref="countryval" name="countryval" ref="countryval" id="countryval" value={this.state.countryval}>
								...
								<div className="form-group col-lg-4 col-md-4 col-xs-12 col-sm-12 valid_box">
									<div className="form-group">
									    ...
									    <select required="true" onChange={this.changeState.bind(this)} title="This field is required" className="inputBox-main stateSelected areaStaes form-control" ref="stateval" name="stateval" id="stateval" value={this.state.stateval}>
											<option >-Select-</option>
								...
								<div className="form-group col-lg-4 col-md-4 col-xs-12 col-sm-12 valid_box">
									<div className="form-group2 ">
									    <label className="" >District<span className="asterix">*</span></label>
									   	<select  title="This field is required" className="inputBox-main distSelected areaStaes form-control" ref="districtval" name="districtval" id="districtval" value={this.state.districtval} onChange={this.changeDist.bind(this)}>
										    <option >-Select-</option>
								...
								<div className="form-group col-lg-4 col-md-4 col-xs-12 col-sm-12 valid_box">
									<div className="form-group2 ">
									    <label className="" >Block/Taluka<span className="asterix">*</span></label>
									   	<select required onChange={this.handleChange.bind(this)} title="This field is required" className="inputBox-main talukaSelected areaStaes form-control" ref="talukaval" name="talukaval" id="talukaval" value={this.state.talukaval}>
										    <option >-Select-</option>
								...
								<div className="form-group col-lg-4 col-md-4 col-xs-12 col-sm-12 valid_box">
									<div className="form-group">	
									    ...
									    <input className="inputBox-main form-control areaStaes nameParts" title="This field is required" id="Village" type="text" name="Village" ref="Village" value={this.state.Village} onChange={this.handleChange.bind(this)}  />
								...
								<div className="form-group col-lg-4 col-md-4 col-sm-12  col-xs-12 valid_box">
									<div className="form-group">
									    ...
									    <input className="inputBox-main form-control areaStaes nameParts" title="This field is required" maxLength="6" type="text" name="pincode" ref="pincode" id="pincode" value={this.state.pincode} onChange={this.handleChange.bind(this)} onKeyDown={this.isNumberKey.bind(this)}  />
