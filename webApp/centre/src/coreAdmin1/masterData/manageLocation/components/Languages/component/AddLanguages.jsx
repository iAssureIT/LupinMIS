    ...
    import addLanguagesdatalist   from '/imports/coreAdmin/masterData/manageLocation/components/Languages/component/addLanguagesdatalist.jsx';
    import Form from 'react-validation/build/form';


    class AddLanguages extends TrackerReact(Component) {
      ...
      addLanguages(event){
        event.preventDefault(); 
           ...
           console.log('languagesValues',languagesValues);
          if($('#Languagesform').valid()){ 
          Meteor.call('insertLanguages',languagesValues,
                      (error, result)=> { 
                          if (error) {
                            ...
                            if(result == 'exist'){
                               swal({
                                title:'abc',
                                text:"Languages Already Added!"
                               });
                            }else{
                             swal({
                              title: 'abc',
                              text: "Languages Added Successfully!",
                              type: 'success',
    ...
    // 
      ...
      showBtn(){
        if(this.state.LanguagesId){
          return(
            <button type="submit" className="pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12 btn submit submit-button updateBTN" onClick={this.updateLanguages.bind(this)}>Update</button>
          )
        }else{
          return(
            <button type="submit" className="pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12 btn submit submit-button btnSubmit" onClick={this.addLanguages.bind(this)}>Submit</button>
          )
        }
      }
      ...
      render(){
        ...
        if(this.state.LanguagesId){
          ...
          var event = this.addLanguages.bind(this)
        }
        
           return(
          <div className=" content-wrapper pageContent add_languages">
              <div className="content">
                <div className="wrapperTitle col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 addLoc">
                    <span className="perinfotitle mgtpprsnalinfo"><i className="fa fa-map-marker" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Add Languages</span>
                  </div>
                ...
                <Form id="Languagesform">  
                  <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 formht countryField" >
                    <div className="form-group">
                      <div className="form-group">
                          <label className="formLabel control-label statelabel col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls" >Languages<span className="astrick">*</span></label>
                          <input className="inputBox-main form-control areaStaes" id="Languages" value={this.state.Languages} ref="Languages" type="text" name="Languages" title="Please enter valid Languages!" onChange={this.handleChange.bind(this)} required/>
                      </div>
                    </div>  
                  </div>
                ...
                <table id="listOfUsersDwnld" className="UMTableSAU table  myTable dataTable  no-footer formTable col-lg-12 col-md-12 col-sm-10 col-xs-12" >
                  <thead className="table-head tablebodyfix "  >
                    <tr className="tempTableHeader " >
                      <th className="umHeader" onclick="sortTable(0)">Languages
                      ...
                      <tbody className="noLRPad tableheaderfix">
                          {this.props.sortedDesc.map( (locationdata,index)=>{
                            return(
                              ...
                              <td className="txtcentr">{locationdata.languages}</td>
                                  ...
                                  <div className=" dropdown">
                                    ...
                                    <div className="dropdown-content  drpdwnpd">
                                      ...
                                      <ul className="pdcls ulbtm">
                                         ...
                                         <li>
                                          <div className=" resetIcon col-lg-12 col-md-12 " id={locationdata._id} onClick={this.editLanguages.bind(this)}>
                                          ...
                                          <div className="modal-content col-lg-12 modDelContent">
                                            <div className="modal-header modDelHeader">
                                              ...
                                              <div className="modal-body deleteMsg">
                                                <p><b>The Languages will be deleted. Are you sure you want to continue?</b></p>
                                            </div>
    ...
    export default AddLanguagesexp = withTracker((props)=>{

        const postHandle = Meteor.subscribe('Languagesdata');
        const post       = Languages.find({},{sort: {createdAt: -1}}).fetch()||{};
