...
export default class LocationBulkupload extends Component{
        	...
        	<div className="blkupld" >
				<div className="wrapperTitle col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 masterHeading">
						<h4><i className="fa fa-map-marker" aria-hidden="true"></i> Add Location</h4>
					</div>
        		...
        		<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 bulkuploadTitle">
					<h4><i className="fa fa-upload" aria-hidden="true"></i> Location Bulk Upload</h4>
				</div>
				<div className="col-lg-12 col-sm-12 col-xs-12 col-md-12 bulkUploadWrapper">
					...
					<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12  csvDLWrap">
						<div className="bulkcountry col-lg-10 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12"><span className="fieldTitle control-label statelabel"><b>Upload Locations</b></span></div>
