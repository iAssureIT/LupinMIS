...
*/
	...
	validateForm() {
	    ...
	    if (typeof fields["districtval"] !== "undefined") {
	      if (fields["districtval"].length < 2 ) {
	        formIsValid = false;
	        errors["districtval"] = "Please enter valid District Name.";
	      }
	    }
	    this.setState({
	      errors: errors
	...
	districtadd(event){
	  event.preventDefault();
	  	...
	  	var districtValues = {
	  		"country" 		: this.refs.countryval.value,
		  	"state" 		: this.refs.stateval.value,	
			"district" 		: this.refs.districtval.value,	
...
*/
	...
	statesortup(){
  	...
  	statesortdown(){
		...
		$("#statesortdown").css('display', 'none');	
  		var sortedDesc =  this.statecountryval.data.sort(function(a, b){
		  return a.stateName > b.stateName;
		}).reverse();
	...
	showBtn(){
		if(this.state.districtId){
			return(
				<button type="submit" className=" submit dt pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12 btn_mrg1  updateBTN" onClick={this.updateDist.bind(this)}>Update</button>
			)
		}else{
			return(
				<button type="submit" className=" submit dt pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12 btn_mrg1" onClick={this.districtadd.bind(this)}>Submit</button>
			)
		}
	}
				...
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 wrapperTitle">
					...
					<div className="switchField col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div className="pull-right">
					      	...
					      	name="options" value="auto" checked={this.state.options === 'auto'} 
        				...
        				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 masterDistrictWrapper " id="adddist">	
							<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 masterDistrictInput">
								<div className="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12 valid_box  ">
									...
									className="inputBox-main countrySelected  areaStaes form-control" ref="countryval" 
									name="countryval" 
									id="countryval" value={this.state.countryval}
								...
								<div className=" form-group col-lg-6 col-md-12 col-sm-12 col-xs-12 valid_box">
								    ...
								    <select onChange={this.handleChange.bind(this)} title="This field is required" className="inputBox-main stateSelected  areaStaes form-control" ref="stateval" name="stateval" id="stateval" value={this.state.stateval}>
									    <option >-Select-</option>
								...
								<div className="form-group  col-lg-12 col-md-12 col-sm-12 col-xs-12 valid_box">
									<div className="form-group ">
									    ...
									    <input className="form-control inputBox-main areaStaes" 
									    type="text" name="districtval" 
									    id="districtval"
									    ref="districtval" 
