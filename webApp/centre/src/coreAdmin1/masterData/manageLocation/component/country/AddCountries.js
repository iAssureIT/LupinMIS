...
*/
  ...
  validateForm() {
    ...
    if (typeof fields["Nationality"] !== "undefined") {
      if (fields["Nationality"].length < 2){
        formIsValid = false;
  ...
  editCountry(event){
    ...
    showBtn(){
      if(this.state.countryId){
        ...
        return(
          <button type="submit" className="pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12  submit  bt-mr count_btn " onClick={this.addcountry.bind(this)}>Submit</button>
        )
      }
    }
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 valid_box countryField " >
                <div className="form-group">
                  <div className="form-group">
                      ...
                      <input className="form-control inputBox-main areaStaes nameParts" 
                      id="Nationality" value={this.state.Nationality}  
                      ref="Nationality" 
                      type="text" 
                      name="Nationality" 
                      ...
                      onChange={this.handleChange.bind(this)} 
                      required/>
                      <div className="errorMsg">{this.state.errors.Nationality}</div>
