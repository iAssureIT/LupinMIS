	...
	*/		}
	...
	handleChange(event){
	  event.preventDefault();
		...
		"blockloctn" 	: this.refs.blockloctn.value,
	...
	validateForm() {
		...
		if (typeof fields["blockloctn"] !== "undefined") {
			if (fields["blockloctn"].length < 2){
			formIsValid = false;
			errors["blockloctn"] = "Please enter valid block name.";
			}
		}
		this.setState({
		errors: errors
	...
	validateFormReq() {
		...
		if (!fields["blockloctn"]) {
		  formIsValid = false;
		  errors["blockloctn"] = "This field is required.";
		}
	...
	showBtn(){
		if(this.state.talukaId){
			...
			return(
				<button type="submit" className="pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12  submit btn_mrg_taluka " onClick={this.talukaadd.bind(this)}>Submit</button>
			)
		}
	}
        			...
        			<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 masterTalukaInput" id="addtaluka">	
						<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 talukaFormAlignment">
							<div className="form-group col-lg-4 col-md-4 col-xs-12 col-sm-12 valid_box">
								...
								<select onChange={this.handleChange.bind(this)} title="This field is required" className="inputBox-main countrySelected  areaStaes form-control" ref="countryval" name="countryval" ref="countryval" id="countryval" value={this.state.countryval}>
							...
							<div className="col-lg-4 col-md-4 col-xs-12 col-sm-12 valid_box">
								<div className="form-group">
								    <label className="control-label " >District<span className="asterix">*</span></label>
								   	...
								   	className="inputBox-main distSelected  areaStaes form-control" ref="districtval" 
								   	name="districtval" id="districtval" value={this.state.districtval} 
							...
							<div className="col-lg-12 col-md-12 col-xs-12 col-sm-12">
								<div className="form-group valid_box">
							    	...
							    	<div className="errorMsg">{this.state.errors.blockloctn}</div>
								</div>									
							</div>	
