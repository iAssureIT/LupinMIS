...
*/	}
	...
	showBtn(){
		if(this.state.stateId){
			...
			return(
				<button type="submit" className="pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12  submit bt-mr  state_btn btnSubmit" onClick={this.Stateadd.bind(this)}>Submit</button>
			)
		}
	}
									...
									<div className="form-group">
										<div className="form-group">
										    <label className="control-label " >Country<span className="asterix">*</span></label>
										   	<select className="areaStaes form-control  selectcountryinstate inputBox-main" title="This field is required" value={this.state.countryval} onChange= {this.handleChange.bind(this)} name="countryval" ref="countryval" id="countryval" >
								...
								<div className="col-lg-6 col-md-6 col-xs-12 col-sm-12 valid_box pdcls">
									<div className="form-group">
                      					<div className="form-group">
										    ...
										    <input className="form-control inputBox-main  areaStaes nameParts" title="This field is required" id="stateval" type="text" name="stateval" value={this.state.stateval} onChange={this.handleChange.bind(this)} />
										</div>
									</div>
								</div>
							{/*</div>*/}
