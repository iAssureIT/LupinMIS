...
export default class StateBulkupload extends Component{
       ...
       return(
        	<div className="blkupld" >
        		...
        		<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 bulkuploadTitle">
					<h4><i className="fa fa-upload" aria-hidden="true"></i> State Bulk Upload</h4>
				</div>
				<div className="col-lg-12 col-sm-12 col-xs-12 col-md-12 stateBulkuploadWrapper" >
					<div className="col-lg-12 col-sm-12 col-xs-12 col-md-12 stateBulkupload">
						<div className="csvDLWrap">
							<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12  markksWrap"></div>
					...
					<div className="col-lg-12  col-md-12 col-sm-12 col-xs-12  csvDLWrap">
						<div className="bulkcountry col-lg-10 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12"><span className="fieldTitle control-label statelabel"><b>Upload States</b></span></div>
