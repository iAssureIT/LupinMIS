       ...
       <div className="row">
          <div className="formWrapper">
              <section className="content">
                ...
                <div className="col-lg-12 ">
                   <h4 className="pageSubHeader">List of Beneficiaries</h4>
                </div>
                <div className="col-lg-12 col-sm-12 col-xs-12" >
                <div className="row">
                 <div className="addContainer col-lg-offset-11 col-lg-1" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus" aria-hidden="true"></i></div>
                  ...
                  <div className="modal-dialog modal-lg " >
                    ...
                    <div className=" col-lg-12 col-sm-12 col-xs-12 formLable boxHeight ">
                      <div className=" col-lg-3 col-md-4 col-sm-6 col-xs-12 ">
                        ...
                        <div className="errorMsg">{this.state.errors.QualificationLevel}</div>
                      </div><div className=" col-lg-3 col-md-4 col-sm-6 col-xs-12 ">
