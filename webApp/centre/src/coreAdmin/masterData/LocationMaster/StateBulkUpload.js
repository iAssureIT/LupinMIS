...
constructor(props) {
  ...
  componentDidMount(){
    ...
    dbdata.push({name: "blockName", type: "string", label:"Block Name"})
    dbdata.push({name: "villageName", type: "string", label:"Village Name"})
    //dbdata.push({name: "blockName", type: "string", label:"State Name"})
    //dbdata.push({name: "areaName", type: "string", label:"Area Name"})
    //dbdata.push({name: "pincode", type: "string", label:"Pincode"})
    ...
    axios
    .get("http://locations2.iassureit.com/api/countries/get/list")
    .then((response)=> {
  ...
  render() {
    ...
    <div className="container-fluid">
      ...
      <br/>
        <BulkUploadComponent url="http://locations2.iassureit.com/api/states/post/bulkinsert" 
        data={{ "countryID" : this.state.countryID }} 
        ...
        fileDetailUrl="http://locations2.iassureit.com/api/states/get/pincodefiledetails/"
