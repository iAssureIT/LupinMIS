...
class MonthlyPlan extends Component{
  ...
  SubmitMonthlyPlan(event){
    event.preventDefault();
    var academicArray=[];
    var id2 = this.state.uID;
    // if (this.validateForm()) {
   var monthlyPlanValues= 
    {
      "year"                : this.refs.year.value,          
      "month"               : this.refs.month.value,          
      // "center"              : this.refs.center.value,
    ...
    this.setState({
      ...
      axios
      .post('https://jsonplaceholder.typicode.com/posts',{monthlyPlanValues})
      ...
      console.log("monthlyPlanValues =>",monthlyPlanValues);
      academicArray.push(monthlyPlanValues);
      console.log("add value",monthlyPlanValues);      
                  ...
                  <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 pageContent ">
                   ...
                   <div className="row">
                    ...
                    <form className="col-lg-12 col-md-12 col-sm-12 col-xs-12 formLable"  style={hidden} id="Academic_details">
                        ...
                        <div className="col-lg-12">
                         <br/><button className=" col-lg-2 btn submit pull-right" onClick={this.SubmitMonthlyPlan.bind(this)}> Submit</button>
                        </div>
                      </form>                    
                    <div className="col-lg-12 ">
                       <h5 className="">Monthly Plan of {this.state.month ? this.state.month : null} { this.state.year !=="-- Select Year --" ? "-"+this.state.year : null}</h5>
                    </div>
