  ...
  SubmitAcademics(event){
    ...
    const modalData = [{
      ...
      const columns = [ 
      {
        ...
        accessor: 'monthYear', 
        Cell: e =><div>
        {/*<div className="customtooltip col-lg-offset-10 col-lg-2 col-md-2 col-xs-2 col-sm-2"><i className="fa fa-question-circle-o fz16" aria-hidden="true"></i>
                          <span className="tooltiptextAccNo">Eg. 6709-9897-9876-4563</span>
                      </div>*/}
                    ...
                    <div class=" ">
                     <div className="col-lg-12  col-md-10 pageContent margTop">
                      ...
                      <form id="form">
                       ...
                       <div className="col-lg-12 col-sm-12 col-xs-12 " id="QualificationLevel" >
                        <div className="addContainerMPV pull-right" onClick={this.toglehidden.bind(this)}> <i class="fa fa-plus" aria-hidden="true"></i></div>
                    </div>
                      <div className="row"> 
                {/*    <div className=" col-lg-12 col-sm-12 col-xs-12 formLable boxHeight ">
                    ...
                    <div className=" col-lg-3 col-md-4 col-sm-6 col-xs-12 ">
                     ...
                     <div className="col-lg-12 col-sm-12 col-xs-12 slowmotion" style={hidden}>
                       <MonthlyForm />
                    </div>

                    <div className=" col-lg-12 col-sm-12 col-xs-12 boxHeightother ">
                      <div className="row">
