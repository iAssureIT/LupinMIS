						        ...
						        <div className="">
						            <section className="">
										     		...
										     		<div className="modal-body adminModal-body col-lg-12 col-md-12 col-sm-12 col-xs-12">
												        ...
												        <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 forgtTextInp NOpadding-left">
															<div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 NOpadding-left">
																...
																<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	<div className="form-group ">
																	 	<label className="col-lg-6 col-md-6 col-sm-12 col-xs-12  label-category formLable">Template Type <span className="astrick">*</span></label>     						
															...
															<div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	<div className="form-group">
																	 	<label className=" label-category formLable">Template Name <span className="astrick">*</span></label>     						
															...
															<div className="row rowPadding subjectRow col-lg-12 col-md-12 col-sm-12 col-xs-12">
																<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	<div className="form-group">
																	 <label className="col-lg-12 col-md-12 col-sm-12 col-xs-12 label-category formLable">Subject <span className="astrick">*</span></label>     						
																        <input type="text" name="subject" data-text="subject" validations={[required]} id="subject" value={this.state.subject} onChange={this.handleChange} className="subject inputBox-main col-lg-12 col-md-12 col-sm-12 col-xs-12 inputValid" required/>
															...
															<div className="row rowPadding col-lg-12 col-md-12 col-sm-12 col-xs-12">
																<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	<div className="form-group">
																	 <label className="col-lg-12 col-md-12 col-sm-12 col-xs-12 label-category formLable">Message <span className="astrick">*</span></label> 
										...
										<div className="box-body">
											<div className="notifTabs col-lg-6 col-lg-offset-3 col-md-9 col-md-offset-3 col-sm-12 col-xs-12">
											  	 <ul className="nav nav-pills nav-pillss notifTab">
												    <li className="active  col-lg-1 col-md-3 col-sm-4 col-xs-12">
												    	<a data-toggle="pill" href="#emailTemplates" > Email 
												    	</a>
												    </li>
												    <li className="col-lg-1 col-md-3 col-sm-3 col-xs-12 ">
												    	<a data-toggle="pill" href="#smsTemplates">
												    		SMS
												    	</a>
												    </li>
												    <li className="col-lg-1 col-md-3 col-sm-4 col-xs-12 ">
