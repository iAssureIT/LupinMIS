...
class ADPReport extends Component{
  ...
  handleChange(event){
    ...
    this.setState({
      "ADPGoal"   : this.refs.ADPGoal.value,          
...
*/    var Goal= 
   ...
   /* fields["Qualification"] = "";
    ...
    axios
    .post('https://jsonplaceholder.typicode.com/posts',{Goal})
    ...
    console.log("academicValues =>",Goal);
    academicArray.push(Goal);
    console.log("add value",Goal);      
                ...
                <div className="">
                   <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 pageContent ">
                      <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 titleaddcontact">
                        ...
                        <form className="col-lg-12 col-md-12 col-sm-12 col-xs-12 formLable" onSubmit={this.SubmitADP.bind(this)} id="ADPReport">
                          <div className="col-lg-12 ">
                             <h4 className="pageSubHeader">ADP (Annual Development Plan) Goal & Sector Mapping</h4>
                          </div>
                          <div className="row">
                            <div className=" col-lg-12 col-sm-12 col-xs-12 formLable valid_box ">
                              
                              <div className=" col-md-6  col-lg-offset-3  col-lg-6 col-sm-6 col-xs-12 ">
                                <label className="formLable">Enter ADP Goal</label><span className="asterix">*</span>
                                <div className="col-lg-12 col-sm-12 col-xs-12 input-group inputBox-main " id="ADPGoal" >
                                  {/*<div className="input-group-addon inputIcon">
                                    <i className="fa fa-graduation-cap fa"></i>
                                  </div>*/}
                                  <input type="text" className="form-control inputBox nameParts" value={this.state.ADPGoal}  placeholder="" name="ADPGoal" onChange={this.handleChange.bind(this)} ref="ADPGoal" />
                                </div>
                                <div className="errorMsg">{this.state.errors.ADPGoal}</div>
                              </div>
                          ...
                          <div className="col-lg-12 col-xs-12 col-sm-12 col-md-12 "><label className="fbold">Please Select Activities to be mapped with above ADP Goal</label></div>
                          <div className="row">
