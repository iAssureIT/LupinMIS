...
class AddTaluka extends Component{
	...
	showBtn(){
		if(this.state.talukaId){
			return(
				<button type="submit" className="pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12 btn submit updateBTN" onClick={this.updateTaluka.bind(this)}>Update</button>
			)
		}else{
			return(
				<button type="submit" className="pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12 btn submit btnSubmit" onClick={this.talukaadd.bind(this)}>Submit</button>
			)
		}
	}
				...
				{this.state.options == 'manual' ? 
        			...
        			<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 masterTalukaInput" id="addtaluka">	
						<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 talukaFormAlignment">
							...
							<div className="form-group col-lg-4 col-md-4 col-xs-12 col-sm-12 formht">
							    <label className="control-label col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls" >State<span className="astrick">*</span></label>
							...
							<div className="col-lg-4 col-md-4 col-xs-12 col-sm-12 formht">
								<div className="form-group">
								    <label className="control-label col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls" >District<span className="astrick">*</span></label>
							...
							<div className="col-lg-12 col-md-12 col-xs-12 col-sm-12">
								<div className="form-group formht">
								    <label className="formLabel control-label col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls" >Block/Taluka<span className="astrick">*</span></label>
								    <input className="inputBox-main form-control areaStaes" title="Please enter valid taluka." id="blockloctn" type="text" name="blockloctn" ref="blockloctn" value={this.state.blockloctn} onChange={this.handleChange.bind(this)} />
								</div>									
							</div>	
														...
														{this.props.post3.map( (locationdata,index)=>{
															return(
																...
																<td className="txtcentr">
																   	<div className="liheader1 dropdown">
																			<div className="">
																			...
																			<div className="dropdown-content  drpdwnpd">
																				...
																				<ul className="pdcls ulbtm">
																				   ...
																				   <li>
																						<div className=" resetIcon col-lg-12 col-md-12 "  id={locationdata._id} onClick={this.editTaluka.bind(this)}>
																					   		<div className="col-lg-3 col-md-3 col-sm-6 col-xs-6 iconUM">
																					    		<i className="fa fa-pencil" aria-hidden="true" title="Edit Taluka" ></i>
																					    	</div>
																				    ...
																				    <li>
																						<div className=" resetIcon col-lg-12 col-md-12" data-toggle="modal" data-target={`#del-${locationdata._id}`}>
																							<div className="col-lg-3 col-md-3 col-sm-6 col-xs-6 iconUM">
																					   			<i className="fa fa-trash" aria-hidden="true" title="Delete Taluka" ></i>
																					   				</div>
																					    	<div className="aligntxtUM">
