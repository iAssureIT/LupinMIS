...
import DistrictBulkupload 		from '/imports/coreAdmin/masterData/manageLocation/components/District/component/DistrictBulkupload.jsx';
import Adddistrictdatalist 		from '/imports/coreAdmin/masterData/manageLocation/components/District/component/Adddistrictdatalist.jsx';
...
class AddDistrict extends Component{
	...
	showBtn(){
		if(this.state.districtId){
			return(
				<button type="submit" className="btn submit dt pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12  updateBTN" onClick={this.updateDist.bind(this)}>Update</button>
			)
		}else{
			return(
				<button type="submit" className="btn submit dt pull-right col-lg-2 col-md-2 col-sm-12 col-xs-12  btnSubmit" onClick={this.districtadd.bind(this)}>Submit</button>
			)
		}
	}
						...
						<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 masterDistrictInput">
							...
							<div className="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 formht">
								<div className="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls">
								    <label className="formLabel control-label" >District<span className="astrick">*</span></label>
								    <input className="form-control inputBox-main areaStaes" id="districtval" type="text" name="districtval" id="districtval" value={this.state.districtval} title="Please enter valid district." onChange={this.handleChange.bind(this)} />
								</div>
							</div>	
						</div>
																   	...
																   	<div className=" dropdown">
																			...
																			<div className="dropdown-content  drpdwnpd">
																				...
																				<ul className="pdcls ulbtm">
																				   ...
																				   <li>
																						<div className=" resetIcon col-lg-12 col-md-12 "  id={locationdata._id} onClick={this.editDistrict.bind(this)}>
