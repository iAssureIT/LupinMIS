						      ...
						      <div className="modal-body col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<form className="editroles">
										...
										<div className="form-group col-lg-2  col-md-4 col-xs-12 col-sm-12 ">
											<label>&nbsp;</label>
										    <button type="button" onClick={this.editDistrict.bind(this)} id={this.props.districtvalues._id} className="btn btn-primary submit" data-dismiss="modal">Update</button>
										</div>
									</form>
						      </div>
