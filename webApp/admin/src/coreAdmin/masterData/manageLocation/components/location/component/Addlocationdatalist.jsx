						      ...
						      <div className="modal-body col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<form className="editroles">
										...
										<div className="form-group col-lg-6 col-md-4 col-xs-12 col-sm-12 pull-right btnpos">
											<label>&nbsp;</label>
										    <button type="button" onClick={this.editlocation.bind(this)} id={this.props.locationValues._id} className="btn btn-primary submit pull-right" data-dismiss="modal">Update</button>
										</div>
									</form>
						      </div>
