...
class EmpowermentLine extends Component{
  ...
  handleChange(event){
    ...
    this.setState({
      "empowermentGoal"   : this.refs.empowermentGoal.value,          
...
*/  var empowermentValues= 
   ...
   /*   "Qualification"       :"",
    ...
    axios
    .post('https://jsonplaceholder.typicode.com/posts',{empowermentValues})
    ...
    console.log("academicValues =>",empowermentValues);
    academicArray.push(empowermentValues);
    console.log("add value",empowermentValues);      
                ...
                <div className="">
                   <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 pageContent ">
                      <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 titleaddcontact">
                        ...
                        <form className="col-lg-12 col-md-12 col-sm-12 col-xs-12 formLable" onSubmit={this.SubmitEmpGoal.bind(this)} id="EmpGoal">
                          <div className="col-lg-12 ">
                             <h4 className="pageSubHeader">Empowerment Line & Sector Mapping</h4>
                          </div>
                          <div className="row">
                            <div className=" col-lg-12 col-sm-12 col-xs-12 formLable valid_box ">
                              
                              <div className=" col-md-6  col-lg-offset-3  col-lg-6 col-sm-6 col-xs-12 ">
                                <label className="formLable">Enter Empowerment Line Goal</label><span className="asterix">*</span>
                                <div className="col-lg-12 col-sm-12 col-xs-12 input-group inputBox-main " id="empowermentGoal" >
                                  {/*<div className="input-group-addon inputIcon">
                                    <i className="fa fa-graduation-cap fa"></i>
                                  </div>*/}
                                  <input type="text" className="form-control inputBox nameParts"  value={this.state.empowermentGoal} onChange={this.handleChange.bind(this)} placeholder="" name="empowermentGoal" ref="empowermentGoal" />
                                </div>
                                <div className="errorMsg">{this.state.errors.empowermentGoal}</div>
                              </div>
                          ...
                          <div className="col-lg-12 col-xs-12 col-sm-12 col-md-12 "><label className="fbold">Please Select Activities to be mapped with above Empowerment Line Goal</label></div>
                          <div className="row">
