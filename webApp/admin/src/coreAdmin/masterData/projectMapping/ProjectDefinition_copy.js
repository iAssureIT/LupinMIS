        ...
        axios({
          ...
          if(response){
            this.setState({
              ...
              console.log("availableSectors1",this.state.availableSectors)
              var availableSectors = this.state.availableSectors;
                editData.sector.map((element)=>{
                  if(availableSectors&&availableSectors.length>0){
                   ...
                   console.log("checkSector",checkSector);
                   if(checkSector>=0){
              ...
              // console.log("availableSectors2===",this.state.availableSectors)
                this.setState({
                  ...
                  // console.log('this.state',this.state.availableSectors);
