...
class ActivityWiseReport extends Component{
    ...
    getData(startDate, endDate, center_ID, sector_ID, projectCategoryType, projectName, beneficiaryType, activity_ID, subActivity_ID){   
        ...
        if(startDate && endDate && center_ID && sector_ID && projectCategoryType  && beneficiaryType){ 
            if(center_ID==="all"){
                if(sector_ID==="all"){
                    var url = ('/api/reports/activitywise_report/'+startDate+'/'+endDate+'/'+"all"+'/all/'+projectCategoryType+'/'+projectName+'/'+beneficiaryType+'/'+activity_ID+'/'+subActivity_ID)
                }else{
                    var url = ('/api/reports/activitywise_report/'+startDate+'/'+endDate+'/'+"all"+'/'+sector_ID+'/'+projectCategoryType+'/'+projectName+'/'+beneficiaryType+'/'+activity_ID+'/'+subActivity_ID)
                }
            }else{
                if(sector_ID==="all"){
