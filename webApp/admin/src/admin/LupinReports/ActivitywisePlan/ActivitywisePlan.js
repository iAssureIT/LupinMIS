    ...
    if(year ){
      if(center_ID && sector_ID && projectCategoryType && projectName && beneficiaryType){ 
        ...
        if (month==="All"){    
          if(center_ID==="all"){
            if(sector_ID==="all"){
              var url = '/api/reports/activity_annual_plans/'+year+'/'+"all"+'/'+projectCategoryType+'/'+projectName+'/all/'+activity_ID+'/'+subActivity_ID
            }else{
              var url = '/api/reports/activity_annual_plans/'+year+'/'+"all"+'/'+projectCategoryType+'/'+projectName+'/'+sector_ID+'/'+activity_ID+'/'+subActivity_ID
            }
          }else{
            if(sector_ID==="all"){
          ...
          if(center_ID==="all"){
            if(sector_ID==="all"){
              var url = ('/api/reports/activity_quarterly_plans/'+month+'/'+year+'/'+"all"+'/'+projectCategoryType+'/'+projectName+'/all/'+activity_ID+'/'+subActivity_ID)
            }else{
              var url = ('/api/reports/activity_quarterly_plans/'+month+'/'+year+'/'+"all"+'/'+projectCategoryType+'/'+projectName+'/'+sector_ID+'/'+activity_ID+'/'+subActivity_ID)
            }
          }else{
            if(sector_ID==="all"){
